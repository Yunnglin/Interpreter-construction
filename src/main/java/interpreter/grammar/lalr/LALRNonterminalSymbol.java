...
public enum LALRNonterminalSymbol implements NonterminalSymbol {
    ...
    */
    ...
    READ_STMT, WRITE_STMT, JUMP_STMT, EXPR, RELATIONAL_EXPR,
    ASSIGN_EXPR, ASSIGN_OP, RELATIONAL_EXPR_MORE, COMPARISON_OP,
    SIMPLE_EXPR, MORE_TERM, ADD_OP, TERM, MORE_FACTOR, MUL_OP,
    FACTOR, NUMBER, PARAM_VALUES, EXPR_STMT,

    // about to delete
    MORE_IDENTIFIER, RETURN_STMT, ASSIGN_STMT, OTHER_ASSIGN,

    // new
    VAR_DECLARATOR, LOGICAL_OR_EXPR, LOGICAL_OR_MORE, LOGICAL_AND_EXPR,
    LOGICAL_AND_MORE, UNARY_OP, POSTFIX_EXPR, POSTFIX_MORE, PRIMARY_EXPR,
