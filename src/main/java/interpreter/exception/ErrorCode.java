...
public enum ErrorCode {
    ...
    WRONG_NEGATIVE_TYPE(3007), SYMBOL_NOT_CALLABLE(3008),

    // execution part
    DIV_BY_ZERO(4001), NEG_ARRAY_SIZE(4002), NON_INTEGER_ARRAY_SIZE(4003),BAD_ARRAY_BOUND(4004),UNMATCH_TYPE(4005),WRONG_OPERATE_TYPE(4006)
