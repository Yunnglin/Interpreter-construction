...
public class CMMParser/*@bgen(jjtree)*/implements CMMParserTreeConstants, CMMParserConstants {/*@bgen(jjtree)*/
  protected static JJTCMMParserState jjtree = new JJTCMMParserState();public Node rootNode()
  {
...
/** Relational expression. */
 ...
 /*@bgen(jjtree) FormDeclaration */
  ...
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
  jjtn000.jjtSetFirstToken(getToken(1));Token t, t2;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case INT:
        jj_consume_token(INT);
        ...
        jjtn000.countToken = t2;
        jjtn000.count = Integer.parseInt(t2.image);
          break;
        default:
          jj_la1[11] = jj_gen;
          ;
 ...
 /*@bgen(jjtree) FormId */
  ...
  jjtn000.jjtSetFirstToken(getToken(1));Token t1, t2;
    ...
    jjtn000.index = Integer.parseInt(t2.image);
    } finally {
    if (jjtc000) {
      jjtree.closeNodeScope(jjtn000, true);
      jjtn000.jjtSetLastToken(getToken(0));
